...
%% Zugeschnitten auf: Commerzbank AG - Praktikant*in im Bereich Big Data & Advanced Analytics - Data Scientist
%% Deutsche Version von main_commerzbank.tex.
%%
%% Kompilieren mit: lualatex main_commerzbank_de.tex
...
\item \textbf{Big Data \& Advanced Analytics}: Großskalige Datenverarbeitung, statistische Anomalieerkennung, Predictive Modeling

\item \textbf{Machine Learning}: Scikit-Learn, Keras, TensorFlow, Random Forest, SVM, K-Means, Klassifikation, Clustering

\item \textbf{Programmierung \& Daten}: Python (Pandas, NumPy), SQL, R, Java, C++

\item \textbf{Finanzdienstleistungserfahrung}: Automatisierung der Datenqualität und regulatorisches Reporting (Deutsche Bundesbank AnaCredit)
